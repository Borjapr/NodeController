...
def getbulkram(IP, PORT):
    ...
    g = bulkCmd(SnmpEngine(),
                ...
                ContextData(),
                N, M,
                ObjectType(ObjectIdentity('AGENT-GENERAL-MIB','agentDRAMutilizationTotalDRAM')),
                ObjectType(ObjectIdentity('AGENT-GENERAL-MIB','agentDRAMutilizationUsedDRAM')),
                ObjectType(ObjectIdentity('AGENT-GENERAL-MIB','agentDRAMutilizationUnitID')),
                ) 
    i=0
    while(i<(M+1)):
        try:
