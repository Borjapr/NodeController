...
def getbulkflash(IP, PORT):
    ...
    g = bulkCmd(SnmpEngine(),
                ...
                ContextData(),
                N, M,
                ObjectType(ObjectIdentity('AGENT-GENERAL-MIB','agentFLASHutilizationTotalFLASH')),
                ObjectType(ObjectIdentity('AGENT-GENERAL-MIB','agentFLASHutilizationUsedFLASH')),
                ObjectType(ObjectIdentity('AGENT-GENERAL-MIB','agentFLASHutilization')),
                ) 
    i=0
    while(i<(M+1)):
        try:
