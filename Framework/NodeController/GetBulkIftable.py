...
def getbulkiftable(IP, PORT):
    ...
    g = bulkCmd(SnmpEngine(),
                ...
                ObjectType(ObjectIdentity('IF-MIB','ifInUnknownProtos')),
                ...
                ObjectType(ObjectIdentity('IF-MIB','ifOutQLen')),
                ObjectType(ObjectIdentity('IF-MIB','ifSpecific')),
